...
setAnswers();
    ...
    private void setAnswers()
    {
        ...
        {
            Toast.makeText(ResetPasswordActivity.this,"please answer bot questions.",Toast.LENGTH_SHORT).show();
        }
        else
        {
                ...
                public void onDataChange(@NonNull DataSnapshot dataSnapshot)
                {
                    if(dataSnapshot.exists())
                    {
                        ...
                        if(dataSnapshot.hasChild("Security Questions"))
                        {
                            ...
                            {
                                Toast.makeText(ResetPasswordActivity.this, "youre 1st answer is wrong", Toast.LENGTH_SHORT).show();
                            }
                            else  if(!ans2.equals(answer2))
                            {
                                Toast.makeText(ResetPasswordActivity.this, "youre 2nd answer is wrong", Toast.LENGTH_SHORT).show();
                            }
                            else
                            {
