...
private DatabaseReference unverifiedProductsRef;
    ...
    private void ChangeProductState(String productID)
    {
        unverifiedProductsRef.child(productID)
            ...
            {
                Toast.makeText(AdminCheckNewProductsActivity.this, "Thate item has been approved, and it is now available for sale from the seller.", Toast.LENGTH_SHORT).show();
